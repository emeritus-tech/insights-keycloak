...
const react_1 = tslib_1.__importDefault(require("@monaco-editor/react"));
...
class CodeEditor extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(react_dropzone_1.default, { multiple: false, onDropAccepted: this.onDropAccepted, onDropRejected: this.onDropRejected }, ({ getRootProps, getInputProps, isDragActive, open }) => {
            const emptyState = providedEmptyState ||
                (isUploadEnabled ? (React.createElement(react_core_1.EmptyState, { variant: react_core_1.EmptyStateVariant.sm },
                    React.createElement(react_core_1.EmptyStateHeader, { titleText: emptyStateTitle, icon: React.createElement(react_core_1.EmptyStateIcon, { icon: code_icon_1.default }), headingLevel: "h4" }),
                    React.createElement(react_core_1.EmptyStateBody, null, emptyStateBody),
                    !isReadOnly && (React.createElement(react_core_1.EmptyStateFooter, null,
                        React.createElement(react_core_1.EmptyStateActions, null,
                            React.createElement(react_core_1.Button, { variant: "primary", onClick: open }, emptyStateButton)),
                        React.createElement(react_core_1.EmptyStateActions, null,
                            React.createElement(react_core_1.Button, { variant: "link", onClick: this.toggleEmptyState }, emptyStateLink)))))) : (React.createElement(react_core_1.EmptyState, { variant: react_core_1.EmptyStateVariant.sm },
                    React.createElement(react_core_1.EmptyStateHeader, { titleText: emptyStateTitle, icon: React.createElement(react_core_1.EmptyStateIcon, { icon: code_icon_1.default }), headingLevel: "h4" }),
                    !isReadOnly && (React.createElement(react_core_1.EmptyStateFooter, null,
                        React.createElement(react_core_1.EmptyStateActions, null,
                            React.createElement(react_core_1.Button, { variant: "primary", onClick: this.toggleEmptyState }, emptyStateLink)))))));
            const tooltipProps = {
            ...
            const editorHeader = (React.createElement("div", { className: (0, react_styles_1.css)(code_editor_1.default.codeEditorHeader) },
                ...
                !!shortcutsPopoverProps.bodyContent && (React.createElement("div", { className: `${code_editor_1.default.codeEditor}__keyboard-shortcuts` },
            ...
            const editor = (React.createElement("div", { className: (0, react_styles_1.css)(code_editor_1.default.codeEditorCode), ref: this.wrapperRef, tabIndex: 0, dir: "ltr" },
                React.createElement(react_1.default, Object.assign({ height: height, width: width, language: language, value: value, options: options, overrideServices: overrideServices, onChange: this.onChange, onMount: this.editorDidMount, theme: isDarkTheme ? 'vs-dark' : 'vs-light' }, editorProps))));
            ...
            }), { className: `${file_upload_1.default.fileUpload} ${isDragActive && file_upload_1.default.modifiers.dragHover} ${isLoading && file_upload_1.default.modifiers.loading}` }),
                editorHeader,
...
CodeEditor.defaultProps = {
    ...
    shortcutsPopoverProps: Object.assign({ bodyContent: '', 'aria-label': 'Keyboard Shortcuts' }, react_core_1.Popover.defaultProps),
    showEditor: true,
    options: {},
    overrideServices: {},
    onCodeChange: () => { }
